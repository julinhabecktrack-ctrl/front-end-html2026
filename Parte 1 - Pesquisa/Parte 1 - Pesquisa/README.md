...
* É conhecido tecnicamente como o *lado do cliente*.
...
* **Servidor:** É um computador potente e distante que armazena os dados do site. Ele processa e responde aos pedidos.
* **Exemplo Prático:** Você digita `google.com` (Cliente pede) e o servidor envia a página de busca de volta (Servidor responde).
...
* **CSS (Estilo):** É a pintura, acabamento e decoração. Define as cores, fontes, tamanhos e o visual do site.
* **JavaScript (Comportamento):** É a fiação elétrica e automação. Cria o dinamismo, como abrir menus, alertas e animações ao clicar.
